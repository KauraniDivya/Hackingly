...
import './App.css';
import coverphoto from "./components/images/coverphoto.png";
...
<div className="w-full lg:w-4/12 px-4 lg:order-1">
 ...
 I'm experienced in both front-end and back-end development using the MERN stack and proficient in UI/UX design with Figma. I'm also proficient in Python Programming and have a basic understanding of DSA in C, C++, and Java, Cloud Computing, OOP and DBMS.

 Ready to collaborate and create amazing web solutions! Let's connect and innovate together. 
                </p>
                </div>
